...
private fun DessertClickerApp(
    ...
    val dessertsSold by viewModel.dessertsSold.collectAsState()
    val currentDessert by viewModel.currentDessert.collectAsState()
...
fun MyDessertClickerAppPreview() {
    DessertClickerTheme {
        val mockViewModel = DessertViewModel()
        DessertClickerApp(viewModel = mockViewModel)
    }
}